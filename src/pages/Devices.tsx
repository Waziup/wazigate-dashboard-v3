import { Box, Button,Grid,CardContent,Typography, Icon,  Modal } from '@mui/material';
import RowContainerBetween from '../components/RowContainerBetween';
import { Add, ArrowBack, Close, Sensors } from '@mui/icons-material';
...
import CreateDeviceTabTwo from '../components/CreateDeviceTab2';
import CreateDeviceTab1 from '../components/CreateDeviceTab1';
            ...
            <Modal
                ...
                >
                    <Box>
                        <Box sx={style}>
                            <RowContainerBetween>
                                <ArrowBack onClick={handleToggleModal} sx={{...IconStyle, fontSize:20}} />
                            ...
                            <Box p={2}>
                                <form onSubmit={submitCreateDevice}>
                                    ...
                                    <CreateDeviceTabTwo selectedValue={selectedValue} />
                                    <Box pt={2}>
                                    ...
                                    <CardContent sx={{py:2}}>
                                        ...
                                        </Button>
                                        {
                                            device.sensors.length>0?device.sensors.map((sensor)=>(
                                                ...
                                                <Box my={2}>
                                                    <Typography sx={{textAlign:'center',fontSize:15, fontWeight:'bold'}}>This device has no sensor</Typography>
                                                </Box>
                                            )
                                        }
                                        {
                                            device.actuators.length>0?device.actuators.map((act)=>(
                                                ...
                                                <Box my={2}>
                                                    <Typography sx={{textAlign:'center',fontWeight:'bold'}}>This device has no actuators</Typography>
                                                </Box>
                                            )
                                        }
                                    </CardContent>
