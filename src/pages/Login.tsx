                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Box p={2}>
                            ...
                            <Box borderBottom={'1px solid #D5D6D8'} display={'flex'} justifyContent={'center'} py={1}>
                                <button type='submit'  style={{width:'70%',border:'none',display:'flex',alignItems:'center',justifyContent:'center', borderRadius:5, outline:'none', padding:10, backgroundColor:'#2BBBAD', color:'white'}}>
