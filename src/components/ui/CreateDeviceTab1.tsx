...
export const DropDownCreateDeviceTab1 = ({name,handleChangeSelect,title,options,matchesWidth,mt,my,value}:{matchesWidth?:boolean,my?:number,mt?:number,name?:string, title?:string, handleChangeSelect:(e:SelectChangeEvent<string>)=>void,  options:{id:string,name:string}[], value: string})=>(
    <FormControl variant="standard" sx={{p:0,mt:mt??2,my:my??0, border:'none', width: '100%',minWidth:matchesWidth?300:300 }}>
