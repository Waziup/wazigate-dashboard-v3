import { SettingsRemoteSharp, Apps, Dashboard, AccountCircle, SettingsTwoTone, Wifi, WifiLock, Logout, HelpCenter, DashboardOutlined, ArrowDropDown } from '@mui/icons-material';
...
function Sidebar({ matchesMd }: { matchesMd: boolean }) {
    ...
    const { setProfile, setAccessToken } = useContext(DevicesContext);
    const handleLogout = () => {
        setProfile(null);
        setAccessToken('');
        navigate('/')
