...
export default function SensorActuatorItem({ sensActuator: sens,anchorEl,handleClose,open,children,deviceId, handleClickMenu }: SensorActuatorItemProps) {
    ...
    return (
        <Grid lg={3} xl={3} md={4} xs={6} sm={3.5} onClick={()=>{navigate(`/devices/${deviceId}/${isActuator(sens)?'actuators':'sensors'}/${sens.id}`)}}  item sx={{ bgcolor: '#fff',cursor:'pointer', mx: matches?2:1, borderRadius: 2 }}>
